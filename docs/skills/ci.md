...
|---|---|---|
| Build OOM or hangs | Memory pressure with 4 builders | Check element build resource usage; for GCC bootstrap ICEs, lower BuildStream scheduler builders/max-jobs in the generated CI config before retrying. In this repo that means keeping `build.max-jobs: 2` in the generated `buildstream-ci.conf` for remote-execution builds. |
